...
import io.github.eeroom.gtop.hz.aspnet.RequestMappingHandler;
import io.github.eeroom.gtop.hz.authen.JwtAuthenticationInterceptor;
import io.github.eeroom.gtop.hz.swagger2.AspNetHandlerMethodResolver;
...
//    }
     ...
     */
    @Bean
    public io.github.eeroom.gtop.hz.aspnet.HandlerMethodArgumentResolver aspNetHandlerMethodArgumentResolver(){
        return new io.github.eeroom.gtop.hz.aspnet.HandlerMethodArgumentResolver();
    }
