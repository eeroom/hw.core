...
import io.github.eeroom.hzoa.aspnet.RequestMappingHandler;
import io.github.eeroom.hzoa.authen.JwtAuthenticationInterceptor;
import io.github.eeroom.hzoa.swagger2.AspNetHandlerMethodResolver;
...
//    }
     ...
     */
    @Bean
    public io.github.eeroom.hzoa.aspnet.HandlerMethodArgumentResolver aspNetHandlerMethodArgumentResolver(){
        return new io.github.eeroom.hzoa.aspnet.HandlerMethodArgumentResolver();
    }

    @Override
    protected void addArgumentResolvers(List<HandlerMethodArgumentResolver> argumentResolvers) {
        //支持asp.net风格的参数模型绑定；根据请求的context-type,自定使用json方式或者表单方式进行模型绑定，不需要额外对参数设置特性）
        argumentResolvers.add(this.getApplicationContext().getBean(io.github.eeroom.hzoa.aspnet.HandlerMethodArgumentResolver.class));
    }
