...
public class Bread {
        ...
        synchronized (this){
            while (this.selling){
                try {
                    ...
                    System.out.printf("make-InterruptedException:"+e.getMessage());
                    return;
                }
            }
            this.num+=1;
        ...
        synchronized (this){
            while (this.selling){
                try {
                    ...
                    System.out.printf("makeV2-InterruptedException:"+e.getMessage());
                    return;
                }
            }
            this.num+=1;
    ...
    public void makeV3(){
        ...
        try {
            ...
            System.out.printf("makeV3-InterruptedException:"+e.getMessage());
            return;
        } finally {
            lock.unlock();
        }
    ...
    public void payV3(){
        ...
        try {
            ...
            System.out.printf("payV3-InterruptedException:"+e.getMessage());
            return;
        } finally {
            lock.unlock();
        }
    ...
    public synchronized void payV2(){
        while(!this.selling){
            try {
                ...
                System.out.printf("payV2-InterruptedException:"+e.getMessage());
                return;
            }
        }
        System.out.printf("消费者:购买面包：%d \r\n",this.num);
    ...
    public synchronized void pay(){
        while(!this.selling){
            try {
                ...
                System.out.printf("pay-InterruptedException:"+e.getMessage());
                return;
            }
        }
        System.out.printf("消费者:购买面包：%d \r\n",this.num);
