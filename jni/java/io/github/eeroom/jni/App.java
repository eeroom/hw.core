...
public class App 
{
    public static void main( String[] args )
    {
        ...
        //64为jdk需要c类库也是按64位编译
        var iaclib=com.sun.jna.Native.load(IAclib.dllName,IAclib.class);
        ...
        var k32= com.sun.jna.Native.load("Kernel32", com.sun.jna.platform.win32.Kernel32.class, com.sun.jna.win32.W32APIOptions.ASCII_OPTIONS);
