...
Source Database       : sf_workflow

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2021-12-29 14:59:24
*/
...
-- ----------------------------
-- Table structure for `kuaidientcustomer`
-- ----------------------------
DROP TABLE IF EXISTS `kuaidientcustomer`;
CREATE TABLE `kuaidientcustomer` (
  `id` varchar(255) NOT NULL,
  `name` varchar(20) NOT NULL,
  `feedbackurl` varchar(1000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of kuaidientcustomer
-- ----------------------------
